...
AudioEffectDelay         delay1;         //xy=294,286
AudioSynthWaveformSineModulated sine_fm2;       //xy=374,101
AudioMixer4              mixer2;         //xy=471,300
AudioMixer4              mixer1;         //xy=472,234
AudioMixer4              mixer3;         //xy=701,292
AudioOutputI2S           i2s1;           //xy=715,176
AudioConnection          patchCord1(sine1, sine_fm1);
...
AudioConnection          patchCord6(delay1, 0, mixer2, 3);
