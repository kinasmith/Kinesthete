...
// GUItool: begin automatically generated code
 ...
 AudioConnection          patchCord6(sine_fm1, 1, mixer1, 1);
 */
// GUItool: begin automatically generated code
AudioSynthWaveform       waveform1;      //xy=97,156
...
AudioConnection          patchCord4(sine_fm1, 0, mixer1, 2);
...
void loop() {
  ...
  if (newLeft != positionLeft || newRight != positionRight || newPitch != positionPitch) {
    ...
    freqFM = linexp(newRight, 0, 1000, 100, 110*8);
    freq = linexp(newPitch, 0, 8000, 1, 110*20);

    AudioNoInterrupts();

    mixer1.gain(0, positionLeft/100.0);
